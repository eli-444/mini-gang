...
export const env = {
  ...
  laPosteFrankingLicense: normalizeEnv(process.env.LA_POSTE_FRANKING_LICENSE),
  ...
  shippingSenderName: normalizeEnv(process.env.SHIPPING_SENDER_NAME),
  shippingSenderLine1: normalizeEnv(process.env.SHIPPING_SENDER_LINE1),
  shippingSenderPostalCode: normalizeEnv(process.env.SHIPPING_SENDER_POSTAL_CODE),
  shippingSenderCity: normalizeEnv(process.env.SHIPPING_SENDER_CITY),
  shippingSenderCountry: normalizeEnv(process.env.SHIPPING_SENDER_COUNTRY),
