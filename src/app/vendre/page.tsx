...
export default async function VendrePage() {
  ...
  const title = isOpen ? "Proposer un colis Mini Gang." : "Le rachat arrive bientôt.";
  const closedText =
    settings.sell_closed_message ||
    "Le parcours de rachat, la cagnotte et les dossiers vendeurs sont volontairement désactivés pour le lancement en Suisse. La boutique se concentre d'abord sur les pièces disponibles, les paiements en CHF et la livraison en Suisse.";
  const openText =
    settings.sell_explanation_text ||
    "Préparez un colis de 10 à 50 vêtements propres, sans taches et sans trous. Mini Gang vous donnera une fourchette claire avant validation.";

  return (
    <div className="bg-[var(--mg-bg)] text-[var(--mg-on-dark)]">
      <section className="mg-container min-h-[auto] py-16 md:min-h-[790px] md:py-36">
        <p className="mg-hand-title text-[2.1rem] text-[var(--mg-pop-sun)] md:text-6xl">VENDRE MES VÊTEMENTS</p>
        ...
        <div className="mt-8 max-w-[96rem] space-y-7 text-[1.45rem] font-black leading-[1.03] md:mt-14 md:space-y-12 md:text-5xl">
          ...
          <p>
            Pour proposer un lot ou poser une question, envoyez-nous quelques photos, tailles, marques et états des
            vêtements.
          </p>
        </div>
